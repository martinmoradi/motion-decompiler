...
function coverageSummary(staticCoverageText, pageModel = {}, approvedExceptionRecords = [], motionDiscovery = []) {
...
function runMapGate(runDir, decision, env = {}) {
  ...
  const coverage = coverageSummary(inputs.staticCoverageText, pageModel, approvedRecords, discoveryBlockers);
