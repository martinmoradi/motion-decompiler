...
which emits one comparable scoreboard so live-capture hit rate and the
failure-cause histogram can be tracked as fixes land.

Kept for provenance only. Do not update these; update the harness output instead.
