...
**Refs:** `cli/engine/browser/injected/index.mjs:499-563`. See [report 01 pattern 2](reports/01-detector-engine.md).
...
**Refs:** `scripts/build-extension.js:49-68`, `cli/engine/browser/injected/index.mjs:1930-1936`. See [report 01 finding 3](reports/01-detector-engine.md) and [report 02 finding 1](reports/02-chrome-extension.md).
...
**Refs:** `cli/engine/rules/checks.mjs:26,755,1718`. See [report 01 §3](reports/01-detector-engine.md).
...
**Refs:** see [report 01 finding 5](reports/01-detector-engine.md).
...
**Refs:** `cli/engine/engines/visual/screenshot-contrast.mjs:65-84,108-183`. See [report 01 pattern 1](reports/01-detector-engine.md).
...
**Refs:** `cli/engine/browser/injected/index.mjs:1468-1474`, `skill/scripts/live-browser.js:867-895`. See [report 01](reports/01-detector-engine.md) and [report 04 pattern 6](reports/04-live-mode-manual-edits.md).
...
**Refs:** see [report 01 surprises](reports/01-detector-engine.md).
...
**Refs:** `cli/engine/node/file-system.mjs:95-186`. See [report 01 pattern 5](reports/01-detector-engine.md).
...
**Refs:** `extension/content/content-script.js:113-123`, `extension/background/service-worker.js:125-137`. See [report 02 finding 2](reports/02-chrome-extension.md).
...
**Refs:** `extension/content/content-script.js:45-69`, `cli/engine/browser/injected/index.mjs:1855-1912`. See [report 02 finding 5](reports/02-chrome-extension.md).
...
**Refs:** `extension/background/service-worker.js:9-12,56-74,244-266`. See [report 02 finding 3](reports/02-chrome-extension.md).
...
**Refs:** `extension/devtools/panel.js:18-34,193`, `service-worker.js:153-186`. See [report 02 finding 4](reports/02-chrome-extension.md).
...
**Refs:** `scripts/build-extension.js:120-159`. See [report 02 surprises](reports/02-chrome-extension.md).
...
**Refs:** see [report 02 surprises / "not to copy"](reports/02-chrome-extension.md).
